...
export class Initial21757535054161 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "zones" ("zone_id" SERIAL NOT NULL, "zone_code" character varying(50) NOT NULL, "zone_name" character varying(100) NOT NULL, "supply_areas" text, CONSTRAINT "PK_b536906901e675e2e30fe819542" PRIMARY KEY ("zone_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "fuel_types" ("fuel_type_id" SERIAL NOT NULL, "fuel_type_code" character varying(10) NOT NULL, "fuel_type_name" character varying(100) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fda4367c7d61155d7a3b33988b9" PRIMARY KEY ("fuel_type_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "rate_cards" ADD CONSTRAINT "FK_69b56d7783fc93db601d7f43832" FOREIGN KEY ("tariff_type_id") REFERENCES "tariff_types"("tariff_type_id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "plans" ADD CONSTRAINT "FK_b5ac348ffd0099f35bb527c2ad1" FOREIGN KEY ("plan_type_id") REFERENCES "plan_types"("plan_type_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
