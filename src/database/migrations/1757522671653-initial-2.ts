...
export class Initial21757522671653 implements MigrationInterface {
  name = 'Initial21757522671653';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "charge_types" ("charge_type_id" SERIAL NOT NULL, "charge_type_code" character varying(50) NOT NULL, "charge_type_name" character varying(100) NOT NULL, "charge_class_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9fc1c4b91507652bcd0c6133f6b" PRIMARY KEY ("charge_type_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "zones" ("zone_id" SERIAL NOT NULL, "zone_code" character varying(50) NOT NULL, "zone_name" character varying(100) NOT NULL, "supply_areas" text, CONSTRAINT "UQ_24b13294e53bbcbcd6d6eb68003" UNIQUE ("zone_code"), CONSTRAINT "PK_b536906901e675e2e30fe819542" PRIMARY KEY ("zone_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "ntc_relns" ("ntc_reln_id" SERIAL NOT NULL, "network_tariff_id" integer, "network_tariff_key_id" integer NOT NULL, CONSTRAINT "PK_2d2fbeb595072c0c60c4bee07fe" PRIMARY KEY ("ntc_reln_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "network_tariffs" ("network_tariff_id" SERIAL NOT NULL, "network_tariff_code" character varying(50) NOT NULL, "usage" boolean NOT NULL DEFAULT false, "demand" boolean NOT NULL DEFAULT false, "controlled_load" boolean NOT NULL DEFAULT false, "solar" boolean NOT NULL DEFAULT false, "distributor_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6ed65993611a71d2ce3f92a1edd" PRIMARY KEY ("network_tariff_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "rate_item_blocks" ("rate_item_block_id" SERIAL NOT NULL, "block_number" integer NOT NULL, "block_rate" numeric(10,8) NOT NULL, "block_consumption" numeric(10,8), "rate_item_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_66cddb647aadaaef12a610bb17a" PRIMARY KEY ("rate_item_block_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "rate_items" ("rate_item_id" SERIAL NOT NULL, "rate_item_name" character varying(255) NOT NULL, "rate_item_details" text, "rate_season_id" integer NOT NULL, "rate_type_id" integer, "rate_period_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_71a7a616e4e08e5cb981a67a29d" PRIMARY KEY ("rate_item_id"))`,
    );
    await queryRunner.query(
